...
from rd_syncrr.utils.pyarr.const import DEPRECATION_WARNING
from rd_syncrr.utils.pyarr.exceptions import PyarrMissingArgument
from rd_syncrr.utils.pyarr.types import JsonArray, JsonObject

from rd_syncrr.utils.pyarr.base import BaseArrAPI

# from .lib.alias_decorator import alias, aliased
from rd_syncrr.utils.pyarr.models.common import PyarrHistorySortKey, PyarrSortDirection
from rd_syncrr.utils.pyarr.models.sonarr import SonarrCommands, SonarrSortKey
...
class SonarrAPI(BaseArrAPI):
    ...
    def get_episode(
        ...
        Args:
            ...
            ep_id (bool, optional): Set to true if the ID is for an Episode. Defaults to false.
        ...
        if series:
            ...
            params = {"episodeFileId": id_}

        return self._get(
            f"episode{'' if series or ep_id else f'/{id_}'}",
            self.ver_uri,
            params=params,
        )
